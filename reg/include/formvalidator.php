...
define("E_VAL_REQUIRED_VALUE","Vul het volgende veld %s");
define("E_VAL_MAXLEN_EXCEEDED","Te veel tekens ingeuld bij %s.");
define("E_VAL_MINLEN_CHECK_FAILED","Voer meer dan %d letters in bij %s");
